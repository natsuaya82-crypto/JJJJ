...
console.log(`世界：国内 ${teams.length}クラブ / 海外 ${INITIAL_FOREIGN_CLUBS.length}クラブ / 選手 ${players.length}人\n`)
...
const shortOf = (id: string) => jpelClubById(useGameStore.getState().clubs, id)?.shortName ?? id
