-- JPEL: build 103 で流すもの（この1本だけ）
--
-- drop table はありません。走友会・フレンド・対戦履歴のデータは消えません。
-- 何回流しても同じ状態になります。
--
-- 中身は2本:
--   1. club_feed.sql   カードの差し入れが「あと0枚」で使えないのを直す
--   2. hof_share.sql   殿堂入りをフレンド・走友会の相手に見せる（build102 で流していれば何も起きません）
...
-- ==========================================================================
-- 2/2  hof_share.sql（build102 で流していれば何も起きません）
-- ==========================================================================
