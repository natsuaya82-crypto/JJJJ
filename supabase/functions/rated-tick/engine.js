...
var PACE_TABLE = [
  ...
  [95, 158],
  [99, 154],
  // ★**110 は優勝トロフィーでしか届かない**（自チームのみ・年最大2個）。
  //   勾配は 95→99 と同じ（1点 = 1.0秒/km）。オーナー判断・2026-08-20
  //   「1能力1個しか上がらんから110はいかんやろ。だから勾配はそれでもいいんじゃないの」
  //   ★**上端は必ず表の外をクランプする**（`lerpAnchors`）。ここを伸ばさないと、
  //     トロフィーを11個使ってもタイムが1秒も変わらない
  [110, 143]
];
