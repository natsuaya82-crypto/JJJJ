...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      '他クラブは「強いから」ではなく「必要だから」動きます。山に穴のあるクラブは山型を狙い、足りているクラブは同じタイプのエースが出ても手を出しません。',
  ...
  },
  {
    ...
    color: C.green,
    lines: [
      '来季予算＝前年の残高＋（クラブ予算＋スポンサー収入＋区間賞＋目標達成ボーナス）−（総年俸＋運営費＋出来高）。',
      '運営費は総年俸の1割です。前年の残高は繰り越されるので、使い切らなければ翌年に持ち越せます。',
