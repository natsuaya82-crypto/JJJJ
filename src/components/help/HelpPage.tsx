...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    color: C.blue,
    lines: [
      '2軍の選手が出場する育成リーグ。参加するとシーズン中に別途レースが行われます。',
      '構成は1軍リーグと同じで、出場できるのが2軍登録の選手という点だけが違います。',
  ...
  },
  {
    ...
    lines: [
      ...
      '年俸・年数・契約形態（本契約/2way契約/育成契約）を提示。合意しても選手が条件に納得しないと成立しません。',
      '契約形態で入る場所が決まります：本契約→1軍、2way契約/育成契約→2軍。',
      '1軍は20名・2軍も上限があり、超える契約は結べません（枠を空けてから）。',
      '他チームの選手は視察して情報を集めるほど、オファーを受け入れてもらいやすくなります。',
    ],
  },
  {
    no: '07',
  ...
  },
  {
    ...
    lines: [
      ...
      'ショップで特訓カードと交換できます。広告視聴は1日3回まで、1回+100J。',
