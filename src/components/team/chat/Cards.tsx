...
export function OfferChatRow({ player, accent, badge, title, sub, onOpen }: {
  ...
  return (
    <button onClick={onOpen} style={{ width: '100%', textAlign: 'left', cursor: 'pointer', fontFamily: 'inherit',background: `linear-gradient(180deg, ${C.surface3}, ${C.surface2})`, border: `1.5px solid ${alpha(accent, 0.4)}`, padding: '10px 12px', marginBottom: 2 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        <div style={{ flexShrink: 0,overflow: 'hidden', border: `1px solid ${alpha(accent, 0.4)}` }}>
