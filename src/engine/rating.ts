...
export const RANK_BANDS = [
  { min: 450, name: 'レジェンド', en: 'LEGEND' },
  { min: 360, name: 'マスター', en: 'MASTER' },
  { min: 280, name: 'ダイヤモンド', en: 'DIAMOND' },
  { min: 200, name: 'プラチナ', en: 'PLATINUM' },
  { min: 120, name: 'ゴールド', en: 'GOLD' },
  { min: 50, name: 'シルバー', en: 'SILVER' },
