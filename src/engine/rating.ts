 ...
 *   2026-08-19 に開始を1000にしたので測り直し（`scripts/measure-rated-season.ts`・
 *   30回戦・下限0つき）：100人で **0〜4911**、いちばん上でもダイヤモンド1人。
 *   **レジェンド（6500）は誰も届かない**＝大会を何度か重ねて乗る段。
 *
 ...
 */
/**
 * **はじめて参加する人のレート。**（オーナー判断・2026-08-19
 * 「全員スタート1000からにしない？」「1000が実質0みたいな感じのイメージ」）
 *
 * ★0スタートだと**初日に負けても減りません**（下限0で止まるので、勝った人だけ増える）。
 *   1000にすると1日目から負けが効きます。
 * ★**下限は0のまま**（オーナー「0のままでいいよ」）＝開始より下へ落ちます。
 *   1日で最大 -380 なので、最短3日で0まで落ちる。
 */
export const RATING_START = 1000

export const RANK_BANDS = [
  { min: 6500, name: 'レジェンド', en: 'LEGEND' },
  { min: 5500, name: 'マスター', en: 'MASTER' },
  { min: 4500, name: 'ダイヤモンド', en: 'DIAMOND' },
  { min: 3500, name: 'プラチナ', en: 'PLATINUM' },
  { min: 2500, name: 'ゴールド', en: 'GOLD' },
  { min: 1500, name: 'シルバー', en: 'SILVER' },
  // ★ブロンズは 0〜1499。**開始の 1000 はこの中**で、負ければ同じ段のまま下がっていく
