...
export function playRateOf(
  ...
  //   移籍の判断（`appraiseMove` の「干されている」など）で「1戦も走っていない」扱いになる。
  //   （当時この形で効いていた関門 `unproven` は 2026-08-20 に廃止。前シーズンを見る理由は残っている）
  ...
  //   毎レース走っている選手が `appraiseMove` の `unproven`（当時の関門・いまは廃止）に当たって
